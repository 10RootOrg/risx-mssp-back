...
async function install_triggers() {
...
//     try {
//         // path_to_config = path.join(__dirname, '..', '..', 'risx-mssp-back', 'mssp_trigerrs.sql');
//                path_to_trig = './mssp_trigerrs.sql';
//         // const data = await fs_promises.readFile(path_to_trig, 'utf8');
//         const trig_file = await fs.readFileSync(path_to_trig);

 
// const  x  = await DBConnection.raw(trig_file);
// console.log("------------x----------",x);
// //  const  x  = await DBConnection.raw(`
...
//             }
        ...
        const error_m = {
          error:"Error install_triggers",
          DiscrError:[err]
        }
        console.error('Error install_triggers:', err);
        return error_m
     }
  } 
