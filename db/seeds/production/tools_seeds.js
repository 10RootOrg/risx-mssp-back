...
exports.seed = async function(knex) {
  ...
  await knex('tools').insert([  
   ...
   }, 
    {
       ...
       description_long: 'Elasticsearch is used for storing, searching, and analyzing structured and unstructured data in near real-time. All data gathered by the various RISX modules is stored and indexed using Elasticsearch, facilitating easy search and analysis.',
       Status: 'blue',
       buttonTitle: 'View',
       ...
       LastRun:"2024-06-02 10:15:17"
        ...
        description_long: 'Timesketch is an open-source collaborative tool designed for forensic timeline analysis, allowing users to organize and analyze timelines collectively. It enables the addition of annotations, comments, and tags to enhance the understanding of raw data.',
        Status: 'blue',
       ...
       },
       {
        ...
        description_long: 'OpenCTI is an open-source platform that enables organizations to manage their cyber threat intelligence by structuring, storing, and visualizing both technical and non-technical information about cyber threats.',
        Status: 'blue',
        buttonTitle: 'Active',
        toolURL: 'https://10root.com/',
        ServicePackage: 'Standard',
       ...
       },
       {
        ...
        description_long: 'IRIS is a collaborative platform for incident response analysts that helps to share investigations at a technical level.',
        Status: 'blue',
        buttonTitle: 'Active',
        toolURL: 'https://10root.com/',
        ServicePackage: 'Standard',
       ...
       },
       {
        ...
        description_long: 'Shodan is a search engine specifically designed to locate and index internet-connected devices, such as webcams, routers, and industrial control systems, by scanning for open ports and service banners.',
        Status: 'blue',
        buttonTitle: 'Explore',
        toolURL: 'https://10root.com/',
        ServicePackage: 'Standard',
       ...
       },
       {
        ...
        description_long: 'Scanning for exposed credentials and sensitive information.',
        Status: 'blue',
        buttonTitle: 'Explore',
