...
if (!path_to_mssp_config_json) {
  ...
  return 'Error: Path to mssp_config.json is undefined.';
    ...
    await fs_promises.writeFile(path_to_mssp_config_json, JSON.stringify(config, null, 2));
...
module.exports = { get_full_config_model,put_full_config_model,Update_mssp_config_json_links_model};
