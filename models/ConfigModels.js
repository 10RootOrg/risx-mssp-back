...
const { DiscrError } = require('ajv/dist/vocabularies/discriminator/types.js')
 ...
 async function put_full_config_model() {
  ...
  console.log("put_full_config_model  "  , the_config_json);
  console.log("put_full_config_model  "  , the_config_json.config.Modules.Nuclei);
